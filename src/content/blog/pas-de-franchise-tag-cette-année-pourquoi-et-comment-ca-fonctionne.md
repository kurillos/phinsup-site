...
description: >-
  ...
  a décidé de ne pas utiliser cet outil parfois utile mais souvent onéreux.
  L'ADN du front office de Miami reprends les pratiques exécutées à Green Bay
  d'où vient le nouveau GM Jon Eric Sullivan et où la discipline financière fait
  mot d'ordre. En évitant le franchise tag, Miami pourrait éviter d'alourdir
  davantage sa masse salariale et s'assurer de pouvoir réaliser de bonnes
  affaires lors de la deuxième vague d'agents libres ou peut garder tout somme
...
Voici comment les calculs sont effectués pour la saison 2026 :

1. **Le franchise tag non exclusif (le plus courant)**

C’est le franchise tag que l’on rencontre **dans 95 % des cas**. Il permet au joueur de négocier avec d’autres équipes, mais s’il signe ailleurs, l’équipe d’origine reçoit deux choix de premier tour en compensation

Le salaire est le plus élevé des deux montants suivants :

* **Le pourcentage moyen du plafond salarial :** Il s’agit d’une formule complexe qui prend la moyenne des cinq salaires les plus élevés à ce poste au cours des cinq dernières années et l’applique en pourcentage du plafond salarial actuel.
* **120 % du salaire précédent du joueur :** Si un joueur était déjà très bien payé (comme un quarterback avec un contrat important), 120 % de son salaire de 2025 pourrait être supérieur au montant standard du contrat.

**2. Le contrat exclusif**

Ce contrat est rarement utilisé (principalement pour les quarterbacks d'élite). Il empêche le joueur de négocier avec une autre équipe. L'équipe ayant le contrôle total, le prix est plus élevé.

Le salaire correspond au plus élevé des deux montants suivants :

* **Moyenne de l'année en cours :** La moyenne des cinq salaires les plus élevés à ce poste pour l'année en cours (calculé en avril après la période des agents libres restreints).
* **120 % du salaire précédent du joueur.**
